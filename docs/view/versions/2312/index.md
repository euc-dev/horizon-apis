---
layout: page
title: VMware View API Reference Documentation - 2312
hide:
 #- navigation
 - toc
---
...
Welcome to the VMware View API Reference documentation v2312. This API reference provides comprehensive information about all data structures available through the View API:
