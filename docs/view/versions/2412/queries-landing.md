...
* To use the paging model, create a query with the [QueryService_Create](../2406/vdi.query.QueryService.md#create) method, get successive results with the [QueryService_GetNext](../2406/vdi.query.QueryService.md#getNext) method, then release server-side resources with the [QueryService_Delete](../2406/vdi.query.QueryService.md#delete) method.
...
* To use the "virtual list" model, use the [QueryService_Query](../2406/vdi.query.QueryService.md#query) method to get one page of results at the offset of your choice.
...
There are various types of controls that can be used to control the result set. These are documented in the [QueryDefinition](../2406/vdi.query.QueryDefinition.md).
