...
---|---|---
**agentUpgradeState**|  xsd:string|  State of the agent upgrade on the machine. [^1] [^2]
...
**agentUpgradeResult**|  xsd:string|  Result of the agent upgrade on the machine. [^1] [^2]
* This property will be one of:
|  Value |  Description
---|---
