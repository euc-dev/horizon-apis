...
**customizationScriptSettings**| [DesktopCustomizationScriptSettings](vdi.resources.Desktop.CustomizationScriptSettings.md)|  Customization scripts to run on a cloned VM.  **_Since_** Horizon 8.11  
