...
**companySize**|  xsd:string|  The size of the company. [^1]
...
**geolocation**|  xsd:string|  The geolocation of the company. [^1]
* This property will be one of:
|  Value |  Description
---|---
...
**vertical**|  xsd:string|  The vertical of the company. [^1]
* This property will be one of:
|  Value |  Description
---|---
