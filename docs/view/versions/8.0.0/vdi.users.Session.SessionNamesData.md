...
**desktopPoolCN**|  xsd:string|  Desktop Pool cn if this is a Desktop session, unset otherwise.  **_Since_** Horizon 7.5 [^1] [^2]
**desktopName**|  xsd:string|  Desktop display name if this is a Desktop session, unset otherwise. [^1]
