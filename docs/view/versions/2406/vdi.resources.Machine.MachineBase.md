...
**type**|  xsd:string|  The type of Machine [^2] <br>* This property will be one of:<br><table><tr><th>Value</th><th>Description</th></tr><tr><td>"MANAGED_VIRTUAL_MACHINE"</td><td>The machine is a managed virtual machine.</td></tr><tr><td>"UNMANAGED_MACHINE"</td><td>The machine is an unmanaged physical or virtual machine.</td></tr><tr><td>"AWS_CORE_MACHINE"</td><td>The machine is an AWS Core managed virtual machine.</td></tr></table>
...
**awsWorkspaceId**|  xsd:string|  AWS Workspace ID of machine in AWS Core pools  **_Since_** Horizon 8.13 [^1]
