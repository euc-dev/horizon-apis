...
**Note:** This will not be set for RDS desktop session when using GlobalSessionQueryService.  **_Since_** Horizon 7.5 [^1] [^2]
**desktopName**|  xsd:string|  Desktop display name if this is a Desktop session, unset otherwise.
**Note:** When using GlobalSessionQueryService, for RDS pool this is set as the [farmName](vdi.users.Session.SessionNamesData.md#farmName). [^1]
...
**clientType**|  xsd:string|  Client type for this session.  **_Since_** Horizon 7.7 [^1] [^2]
* This property will be one of:
|  Value |  Description
---|---
...
**securityGatewayLocation**|  xsd:string|  Location of the security gateway.  **_Since_** Horizon 7.7 [^1] [^2]
* This property will be one of:
|  Value |  Description
---|---
