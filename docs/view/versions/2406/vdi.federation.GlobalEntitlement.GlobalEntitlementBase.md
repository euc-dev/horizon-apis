...
**enablePcoipUltraProtocol**|  xsd:boolean|  Enable Pcoip ULTRA protocol. If enabled, Pcoip ULTRA can be used as display protocol for VDI sessions  **_Since_** Horizon 8.13 [^5] [^1]
