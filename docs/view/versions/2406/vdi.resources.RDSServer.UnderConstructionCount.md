...
**waitForHybridDomainJoin**|  xsd:int|  Number of RDS server machines which are in AGENT_ERR_WAIT_FOR_HYBRID_JOIN [status](vdi.resources.RDSServer.RDSServerStateView.md#status) **_Since_** Horizon 8.13  
